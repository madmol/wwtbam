...
class GameHelpGenerator
  ...
  # процентах correct_key — ключ правильного ответа, он будет выбран с бОльшим
  # весом
  ...
  def self.friend_call(keys, correct_key)
    # С ~80% вероятностью выбираем правильный ключ, и с 20% - неправильный
